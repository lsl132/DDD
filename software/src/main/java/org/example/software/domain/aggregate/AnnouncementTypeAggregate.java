 ...
 */
@Getter
public class AnnouncementTypeAggregate implements Serializable {

    private Integer id;
    private String name;
    private Date createTime;

    public AnnouncementTypeEntity aggregateToEntity() {
        AnnouncementTypeEntity entity = new AnnouncementTypeEntity();
    ...
    private AnnouncementTypeAggregate(Builder builder) {
        this.id = builder.id;
    ...
    public static class Builder {
        ...
        public AnnouncementTypeAggregate build(){
            return new AnnouncementTypeAggregate(this);
        }
    }
